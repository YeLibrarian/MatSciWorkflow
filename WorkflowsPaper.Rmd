...
type of action, equipment, and methods used were recorded using standardized codes. (See *Appendix II* for coding method and dictionary.) This tabular data was then used to impute collaboration and data-dependency graphs (see the *Results* section below).
...
flow graph). (See Appendix III-A for detailed process)
...
three categories -- information sharing, information security, and information organization. (See *Appendix IV* for description of the practices.)
